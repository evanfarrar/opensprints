...
#numbers text{ font-family: Nimbus Sans L; }

.number_shadow {
  font-size: 20.40035629px;
  fill: black;
}

.number {
  font-size: 20.30507278px;
  fill: white;
}
...
.red #back {
  fill: #d3040a;
  stroke: black;
  stroke-width: 2.58699989;
}
.red #outer {
  fill: #d3040a;
  stroke: black;
  stroke-width: 0.53463411;
}
.red #inner {
  fill: #abbcf4;
  stroke: #282c37;
  stroke-width: 0.62400103;
}
.blue #back {
  fill: #abbcf4;
  stroke: black;
...
w.child.render_data(doc.gsub(/%([^s])/,'%%\1') % [@red_dasharray, @blue_dasharray, @blue_pointer_angle, @red_pointer_angle],"http://foo","application/xml")
Gtk.main
