xml.svg(:height => "741", :width => "993", :viewBox => "0 0 499 378",
  ...
  xml.rect(
     :rx=>"114.26359",
     :style=>"fill:none;stroke:#d3040a;stroke-width:19.05940628;stroke-dasharray:0,1",
     :ry=>"124.54852",
     :y=>"25.751932",
     :x=>"30.173487",
     :height=>"321.5343",
  ...
  xml.rect(
     :rx=>"105.68902",
     :style=>"fill:none;stroke:#abbcf4;stroke-width:17.33102798;stroke-dasharray:0,1;",
     :ry=>"111.33588",
     :y=>"43.110508",
     :x=>"47.228378",
     :height=>"287.42456",
